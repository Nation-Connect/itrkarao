            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-adress">
                            <div class="part-icon">
                                <i class="fa fa-phone" style="line-height: 2;"></i>
                            </div>
                            <div class="part-text">
                                <h3>Phone Number</h3>
                                <ul>
        ...
        <div class="get-in-touch">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <div class="section-title">
                            <h2>Get In Touch</h2>
                            <p style="text-align: center;">Contact us here, and we will respond to your inquiry as soon as we can</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="part-form">
                            <img style="padding-left:100px;" src="../static/mainstatic/img/contact2.gif" alt="">
                        </div>
                    </div>
                </div>
            </div>
